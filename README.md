...
Это простые числа. Это необязательное требование к размеру таблицы, но функции, обладающие свойством периодичности. Так мы уменьшаем вероятность скопления элементов по значениям хеша, кратным этому периоду, и, как следствие, улучшаем итоговое распределение функции.
