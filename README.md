...
По результатам профилирования снова в топ вышла функция поиска, но, к сожалению, оптимизировать её не представляется возможным, так как в ней находится просто вызов расчёт хеша и цикл, пробегающийся по соответствующему списки. Было решено проанализировать ещё раз работу хеш-функции.

Ранее мы решили считать её по блокам, но перед этим мы считали её длины. Было выдвинуто предположение, что нет смысла считать её длины и считать хеш именно этого фрагмента строки. В рамках первой оптимизации мы упаковали все строки по 32 символа, поэтому теперь можно считать хеш от всей этой строки, не пренебрегая нулевыми символами в конце.
