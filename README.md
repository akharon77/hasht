...
По результатам профилирования **базовой версии** было решено ускорить функцию поиска, а конкретно функцию сравнения строк. Для этого все строки после считывания были расширены и переупакованы в строки по 32 символа. Этого хватит для нашей задачи, так как длина слов не превышает 22 символов. Таким образом, сравнение строк можно проводить при помощи AVX команд.
