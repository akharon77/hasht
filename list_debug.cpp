...
//         ListDumpGraphEdge(anch, anch + 1, "#00000000", EDGE_BASE_WEIGHT, fd_dump_graph);
//     
...
// {
//     dprintf(fd_dump, "node%d[shape=record, style=\"filled\", fillcolor=\"%s\", label = \
//                       \"{ind: %d | val: %d | {prev: %d | next: %d}}\", \
